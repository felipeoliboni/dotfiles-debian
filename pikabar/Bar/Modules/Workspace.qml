    ...
    Row {
        ...
        Repeater {
            ...
            Item {
                ...
                Text {
                                    id: workspaceNumber
                                    // Usamos 'model.id' ou 'model.idx' dependendo de como o WorkspaceManager do PikaOS indexa. 
                                    // Geralmente o 'id' é o número lógico (1, 2, 3...)
                                    text: model.name
                                    
                                    font.pixelSize: 10 * Theme.scale(screen) // Ajuste o tamanho da fonte
                                    color: model.isFocused ? (Theme.onAccentPrimary || "#ffffff") : (Theme.textPrimary || "#cccccc")
                                    anchors.centerIn: parent 
                                    
                                    // Transparência: só mostra o número se o workspace estiver ocupado/focado.
                                    opacity: model.isFocused || model.isActive || model.isOccupied ? 1.0 : 0.4
                                    
                                    // Adiciona animação à cor e opacidade
